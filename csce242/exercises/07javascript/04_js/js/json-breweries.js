...
const showBreweries = async() => {
    ...
    breweries.forEach(async(brewery)=>{
        ...
        //creating h3 element to display brewery name
        const h3 = document.createElement("h3");
        h3.innerHTML = brewery.name;
        a.append(h3);

        //creating p element to display city, state, and phone
        const p = document.createElement("p");
        p.innerHTML = `City: ${brewery.city}
        <br>State: ${brewery.state}
        <br>Phone: ${brewery.phone}
        <br>Brewery Type: ${brewery.brewery_type}`;
        section.append(p);
